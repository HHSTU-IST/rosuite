...
namespace ros_tracker::filters::detail
{
  ...
  Result<Vector> weighted_mean_from_columns(
  ...
  Result<Covariance> weighted_covariance_from_columns(
      const Matrix &samples,
      const Vector &weights,
      const Vector &mean)
  {
  ...
  Result<Matrix> weighted_cross_covariance_from_columns(
  ...
  Result<GaussianEstimate> predict_from_sigma_points(
  ...
  Result<GaussianEstimate> correct_from_sigma_points(
      const GaussianEstimate &estimate,
      const SigmaPointSet &sigma_points,
  ...
  Result<GaussianEstimate> estimate_from_ensemble(
